...
// void update(long long segTree[], long long index, long long val, int n)
// {
//     segTree[n + index] = val;
//     for (int j = (index + n) / 2; j >= 1; j /= 2)
//     {
...
//         {
//             l--;
//             update(segTree, l, r, n);
//         }
//         else
//         {
//             l--, r--;
//             ans = query(segTree, 1, 0, n - 1, l, r);
//             cout << ans << '\n';
//         }
//     }
//     return 0;
